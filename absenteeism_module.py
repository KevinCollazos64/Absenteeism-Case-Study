...
class absenteeism_model():
        ...
        # take a .csv file and preprocess it in the same way
        def load_and_clean_data(self, data_file):
            ...
            # to preserve the code previously created, we add a column with 'NaN' strings
            ...
            # line of code if you want to call the 'preprocessed data'
            self.preprocessed_data = df.copy()
            
            # line so we can use it in the next functions
